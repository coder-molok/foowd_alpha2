define({ "api": [
  ...
  },
  {
    ...
    "name": "create",
    "group": "Prefer",
    "description": "<p>Crea una nuova offerta (state &quot;newest&quot;), o incrementa/decrementa della quantita&#39; l&#39;offerta con stato (&#39;pending&#39; o &#39;newest&#39;) lasciando inalterate quelle in status &#39;solved&#39;. <br/> Se l&#39;offerta raggiunge la Quota zero o inferiore allora viene eliminata.</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    ...
    "name": "create",
    "group": "Purchase",
    "description": "<p>Crea un nuova ordine assegnandogli stato &quot;pending&quot; di default.</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "LeaderId",
            "description": "<p>id esterno del capogruppo</p> "
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "prefersList",
            "description": "<p>lista delle preferenze associate all&#39;offerta</p> "
          }
        ],
        "Response": [
          {
    ...
    "version": "0.0.0",
    "filename": "foowd_alpha2/api_foowd/app/routes/actions/FApi/ApiPurchase.php",
    "groupTitle": "Purchase"
  },
  {
    "type": "post",
    ...
    "name": "search",
    "group": "Purchase",
    "description": "<p>ritorna tutte le ordinazioni filtrandole per stato.</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    ...
    "name": "solve",
    "group": "Purchase",
    "description": "<p>Dato l&#39;id di un ordine lo chiude attualizzando le preferenze. <br/> Viene utilizzato un solo ordine per volta in modo da garantire una semplice e lineare gestione degli errori, preferendo svolgere piu chiamate di chiusura, avendo considerato che la chiusura di un&#39;ordine e&#39; un&#39;operazione che non avviene poi cosi&#39; di frequente.</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "PurchaseId",
            "description": "<p>id dell&#39;ordine</p> "
          }
        ],
        "Response": [
          {
