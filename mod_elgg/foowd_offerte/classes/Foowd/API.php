...
class API{
	 ...
	 * 
	 * @param [type] $route  non la reale route del path, 
	 *                       ma un parametro per chiamare l'adeguato metodo nel sito delle API,
	 *                       in questo caso nel formato oggetto/metodo relativo al sito API
	 * 
