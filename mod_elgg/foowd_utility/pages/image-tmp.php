...
// inserire if su un parametro per decidere se serve essere loggati o meno
// quando devo fare il login non sono ancora loggato!!
//elgg_gatekeeper();
...
foreach($_FILES as $file){
	...
	$r['src'] = base64_encode(file_get_contents($file["tmp_name"]));
	$r['message'] = "File ". basename( $file["tmp_name"]). " salvato con successo.";
    $r['response'] = true;
}
